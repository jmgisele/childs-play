...
Mostly: because I was at a retreat at the Recurse Center! I wanted to pick up the basics of how graphics programming works, dip my toes back into the sort of math I'd enjoyed doing in my Physics undergrad, and learn Rust. I found porting an existing C++ project to be a good way to do all of those things.
