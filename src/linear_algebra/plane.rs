...
pub fn triangle_clip_plane(
    ...
    if inside_count == 0 {
        ...
        *tri_arr[1].vertices[0] = *inside_points[1];
        *tri_arr[1].vertices[1] = *in_tri.vertices[2];
        *tri_arr[1].vertices[2] =
